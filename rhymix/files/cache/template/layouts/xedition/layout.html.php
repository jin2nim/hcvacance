...
$__Context->_sample_footer = false;
	...
	<?php if(isset($__Context->act) && in_array($__Context->act, $__Context->_fixed_width_act)){ ?>
		<?php  $__Context->_body_class[] = 'fixed-width' ?>
...
$__Context->layout_info->use_demo = 'N';
	...
	<?php if(isset($__Context->act) && $__Context->act === 'dispPageAdminContentModify'){;
$__Context->layout_info->use_demo = 'N';
} ?>
...
<!--#Meta:layouts/xedition/css/layout.css--><?php Context::loadFile(['layouts/xedition/css/layout.css', '', '', '', []]); ?>
<!--#Meta:layouts/xedition/css/idangerous.swiper.css--><?php Context::loadFile(['layouts/xedition/css/idangerous.swiper.css', '', '', '', []]); ?>
<!--#Meta:layouts/xedition/css/welcome.css--><?php Context::loadFile(['layouts/xedition/css/welcome.css', '', '', '', []]); ?>
<!--#Meta:layouts/xedition/css/webfont.css--><?php Context::loadFile(['layouts/xedition/css/webfont.css', '', '', '', []]); ?>
<?php if($__Context->mid === 'xeicon'){ ?><!--#Meta:layouts/xedition/css/xeicon.css--><?php Context::loadFile(['layouts/xedition/css/xeicon.css', '', '', '', []]);
} ?>
<!--#Meta:common/css/xeicon/xeicon.min.css--><?php Context::loadFile(['common/css/xeicon/xeicon.min.css', '', '', '', []]); ?>
<?php if($__Context->_enable_slide){ ?><!--#Meta:layouts/xedition/js/idangerous.swiper.min.js--><?php Context::loadFile(['layouts/xedition/js/idangerous.swiper.min.js', '', '', '']);
} ?>
<!--#Meta:layouts/xedition/js/layout.js--><?php Context::loadFile(['layouts/xedition/js/layout.js', '', '', '']); ?>
<?php if($__Context->layout_info->use_demo ==='Y'){ ?><!--#Meta:layouts/xedition/js/welcome.js--><?php Context::loadFile(['layouts/xedition/js/welcome.js', '', '', '']);
} ?>
<!--#Meta:layouts/xedition/js/jquery.parallax-scroll.min.js--><?php Context::loadFile(['layouts/xedition/js/jquery.parallax-scroll.min.js', '', '', '']); ?>
					...
					<li class="hover">
						<?php if($__Context->is_logged){ ?>
							...
							<a href="<?php echo getUrl('act', 'dispMemberInfo') ?>" class="login_after">
								<?php if(!empty($__Context->logged_info->profile_image->src)){ ?>
									<img src="<?php echo $__Context->logged_info->profile_image->src ?>" alt="<?php echo $__Context->logged_info->nick_name ?>" />
								<?php }else{ ?>
									<img src="/rhymix/layouts/xedition/img/ico_default.jpg" alt="<?php echo $__Context->logged_info->nick_name ?>" />
								<?php } ?>
							</a>
...
$__Context->_subheader_img = 'sub_banner_xeicon.jpg';
	...
	<div class="body <?php echo $__Context->_body_class ?>">
		<!-- LNB -->
		<?php if(isset($__Context->_selected_menu['list']) && $__Context->_selected_menu['list'] && $__Context->layout_info->layout_type === 'sub' && $__Context->layout_info->sidebar_position !== 'none'){ ?><nav class="lnb">
			<ul>
...
<?php } ?>
<!-- Login widget -->
<?php if($__Context->layout_info->use_login_widget != 'N'){ ?><section class="login_widget"<?php if(($__Context->XE_VALIDATOR_ID ?? '') !== 'layouts/xedition/layout/1' || !isset($__Context->XE_VALIDATOR_MESSAGE)){ ?> style="display:none"<?php } ?>>
	<!--#Meta:layouts/xedition/css/widget.login.css--><?php Context::loadFile(['layouts/xedition/css/widget.login.css', '', '', '', []]); ?>
	...
	<div class="signin">
		...
		<div class="login-body">
			<form action="<?php echo getUrl('', 'act', 'procMemberLogin') ?>" method="post" autocomplete="off"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" />
...
echo $lang->email_address;
					...
					<?php if(isset($__Context->XE_VALIDATOR_ID) && $__Context->XE_VALIDATOR_ID == 'layouts/xedition/layout/1' && isset($__Context->XE_VALIDATOR_MESSAGE)){ ?><div class="control-group">
