...
Context::addJsFile("modules/layout/ruleset/updateLayout.xml", FALSE, "", 0, "body", TRUE, "") ?><form id="config_form"  action="./" enctype="multipart/form-data" method="post"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" /><input type="hidden" name="ruleset" value="updateLayout" />
...
echo $__Context->var->value;
					...
					<?php if($__Context->var->type == 'image'){ ?>
						...
						<div id="preview_<?php echo $__Context->name ?>" class="x_thumbnail" style="<?php if(!$__Context->var->value){ ?>display:none;<?php } ?>max-width:210px;margin-bottom:20px;">
							<img<?php if($__Context->var->value){ ?> src="/rhymix/<?php echo $__Context->var->value ?>"<?php } ?> alt="" style="max-width:100%" />
						...
						<form action="./" enctype="multipart/form-data" method="post" target="hiddenIframe" class="imageUpload" style="margin:0"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" />
							<input type="hidden" name="module" value="layout" />
						...
						<div class="x_thumbnails">
							<?php if($__Context->var->options)foreach($__Context->var->options as $__Context->key=>$__Context->val){ ?>
								<div class="x_span2 <?php if($__Context->val->thumbnail){ ?>x_thumbnail<?php } ?>">
									<?php if($__Context->val->thumbnail){ ?><img src="/rhymix/<?php echo $__Context->val->thumbnail ?>" alt="<?php echo $__Context->val->val ?>" /><?php } ?>
									<div class="x_caption">
