<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/menu/tpl/css/sitemap.css--><?php Context::loadFile(['modules/menu/tpl/css/sitemap.css', '', '', '11', []]); ?>
<!--#Meta:modules/menu/tpl/js/_lib/jquery.cookie.js--><?php Context::loadFile(['modules/menu/tpl/js/_lib/jquery.cookie.js', '', '', '']); ?>
<!--#Meta:modules/menu/tpl/js/jquery.scrollTo-1.4.2.js--><?php Context::loadFile(['modules/menu/tpl/js/jquery.scrollTo-1.4.2.js', '', '', '']); ?>
...
<?php if($__Context->act == 'dispMenuAdminSiteMap'){ ?>
	<div class="col map" id="site_map">
		...
		<form id="menu_find"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?? ''; ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" />
		...
		<button type="button" class="x_btn x_btn-link _addSiteMap1" data-admin-show="#add_sitemap" style="position:absolute;right:6px;bottom:6px;color:#000"><i class="x_icon-plus-sign"></i> <?php echo $lang->add_new_sitemap ?></button>
	</div>
		...
		<section>
			...
			<div class="cnt">
				<ul class="nav">
					...
					<li><a href="#sitemap_batch_design" data-admin-show="#sitemap_batch_design"><?php echo $lang->sitemap_batch_design ?> <i class="x_icon-circle-arrow-right"></i></a></li>
	...
	<div class="col" id="sitemap_batch_design" style="display:none">
		<section>
			<h1><?php echo $lang->sitemap_batch_design ?></h1>
			<div class="cnt">
				<ul class="_itemList">
					<li>
						<label for="layout_P"><?php echo $lang->pc ?> <?php echo $lang->layout ?></label>
						<select name="layout_P" id="layout_P">
							<option value="0"></option>
							<?php if($__Context->layouts_P)foreach($__Context->layouts_P as $__Context->layout_i){ ?>
								<option value="<?php echo $__Context->layout_i->layout_srl ?>"><?php echo $__Context->layout_i->title ?></option>
							<?php } ?>
						</select>
					</li>
					<li>
						<label for="layout_M"><?php echo $lang->mobile ?> <?php echo $lang->layout ?></label>
						<select name="layout_M" id="layout_M">
							<option value="0"></option>
							<?php if($__Context->layouts_M)foreach($__Context->layouts_M as $__Context->layout_i){ ?>
								<option value="<?php echo $__Context->layout_i->layout_srl ?>"><?php echo $__Context->layout_i->title ?></option>
							<?php } ?>
						</select>
					</li>
				...
				<div class="btnBoth">
					<button type="reset" class="x_btn x_pull-left" data-admin-hide="#sitemap_batch_design"><?php echo $lang->cmd_cancel ?></button>
					<button type="button" class="x_btn x_btn-primary x_pull-right _save"><?php echo $lang->cmd_confirm ?></button>
				</div>
			</div>
		</section>
	...
	<div class="col" id="add" style="display:none">
		...
		<a href="#download" class="x_btn x_btn-link" data-admin-show="#download" style="position:absolute;right:6px;bottom:6px;color:#000"><i class="x_icon-plus-sign"></i> <?php echo $lang->install_other_menu_types ?></a>
				...
				<ul>
					...
					<li>
						<div class="x_input-append">
							<label for="menuIcon2"><?php echo $lang->menu_icon ?></label>
							<input id="menuIcon2" class="_menuIcon" type="text" />
						</div>
						<p><?php echo $lang->about_menu_icon ?></p>
					</li>
					<li>
						<div class="multilingual x_input-append">
		...
		<fieldset>
			...
			<div class="cnt">
				<ul>
					...
					<li>
						<div class="x_input-append">
							<label for="menuIcon"><?php echo $lang->menu_icon ?></label>
							<input id="menuIcon" class="_menuIcon" type="text" />
						</div>
						<p style="width:220px;min-width:100%"><?php echo $lang->about_menu_icon ?></p>
					</li>
					<li>
						<div class="multilingual x_input-append">
	...
	<div class="col" id="imgbtn" style="display:none">
		<fieldset>
			...
			<div class="cnt">
				...
				<form action="?module=menu&act=procMenuAdminButtonUpload" class="_btn_normal" target="submitTarget" method="post" enctype="multipart/form-data"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?? ''; ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" />
					...
					<figure>
						...
						<img class="_thumbnail" src="/rhymix/common/img/blank.gif" alt="<?php echo $lang->about_menu_normal_btn ?>">
					</figure>
					<div class="btnBoth">
				...
				<form action="?module=menu&act=procMenuAdminButtonUpload" class="_btn_hover" target="submitTarget" method="post" enctype="multipart/form-data"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?? ''; ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" />
					...
					<figure>
						...
						<p class="noImg"><?php echo $lang->menu_no_img_btn ?></p>
						<img class="_thumbnail" src="/rhymix/common/img/blank.gif" alt="<?php echo $lang->about_menu_hover_btn ?>">
					</figure>
					<div class="btnBoth">
						<button type="submit" class="delete x_btn x_pull-left"><?php echo $lang->cmd_delete ?></button>
						<span class="fileBtn x_btn x_pull-right">
				...
				<form action="?module=menu&act=procMenuAdminButtonUpload" class="_btn_selected" target="submitTarget" method="post" enctype="multipart/form-data"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?? ''; ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" />
					...
					<figure>
						...
						<p class="noImg"><?php echo $lang->menu_no_img_btn ?></p>
						<img class="_thumbnail" src="/rhymix/common/img/blank.gif" alt="<?php echo $lang->about_menu_active_btn ?>">
					</figure>
					<div class="btnBoth">
						<button type="submit" class="delete x_btn x_pull-left"><?php echo $lang->cmd_delete ?></button>
						<span class="fileBtn x_btn x_pull-right">
	...
	<?php } ?>
		<fieldset>
			...
			<div class="cnt">
				<form action="./" target="xe_preview" class="_preview_form" method="post"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?? ''; ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" />
	...
	<div class="col theme" id="layout" style="display:none">
		<form action=""><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?? ''; ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" />
					...
					<ul class="_layout_list">
						...
						<li data-admin-show="#downloadLayout">
							...
							<button type="button" class="item _btnScreenshot">
								<img src="/rhymix/modules/layout/tpl/img/download.png" class="_thumbnail" alt="<?php echo $lang->install_other_layouts ?>">
							</button>
						</li>
						</script>
				...
				<div class="list">
					<ul class="_list">
						...
						<li data-admin-show="#downloadSkin">
							...
							<button type="button" class="item _btnScreenshot">
								<img src="/rhymix/modules/layout/tpl/img/download.png" class="_thumbnail" alt="<?php echo $lang->install_other_skins ?>">
							</button>
						</li>
						</script>
...
<script>
	...
	xe.lang.msg_url_is_required = '<?php echo $lang->msg_url_is_required ?>';
