<?php if(!defined("__XE__"))exit;?><script src="/rhymix/modules/board/tpl/js/board_admin.js"></script>
<script src="/rhymix/modules/board/tpl/modules/module/tpl/js/module_admin.js"></script>
<script>
</script>
<?php Context::addJsFile("modules/board/ruleset/insertBoardForBasic.xml", FALSE, "", 0, "body", TRUE, "") ?><form  id="fo_obj" class="x_form-horizontal" action="./" method="post" enctype="multipart/form-data"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?? ''; ?>" /><input type="hidden" name="ruleset" value="insertBoardForBasic" />
