...
<?php if($__Context->module_info->use_category=='Y' && isset($__Context->list_config)){ ?><ul class="cTab">
	...
	<?php if($__Context->cate_list)foreach($__Context->cate_list as $__Context->key=>$__Context->val){ ?><li<?php if(isset($__Context->category) && $__Context->category == $__Context->val->category_srl){ ?> class="on"<?php } ?>><a href="<?php echo getUrl('category',$__Context->val->category_srl,'document_srl','', 'page', '') ?>"><?php echo $__Context->val->title ?><!--<?php if($__Context->val->document_count){ ?><em>[<?php echo $__Context->val->document_count ?>]</em><?php } ?>--></a>
		<?php if(count($__Context->val->children)){ ?><ul>
			<?php if($__Context->val->children)foreach($__Context->val->children as $__Context->idx=>$__Context->item){ ?><li<?php if(isset($__Context->category) && $__Context->category == $__Context->item->category_srl){ ?> class="on_"<?php } ?>><a href="<?php echo getUrl('category',$__Context->item->category_srl,'document_srl','', 'page', '') ?>"><?php echo $__Context->item->title ?><!--<?php if($__Context->val->document_count){ ?><em>[<?php echo $__Context->item->document_count ?>]</em><?php } ?>--></a></li><?php } ?>
		</ul><?php } ?>
	</li><?php } ?>
</ul><?php } ?>
...
<div class="list_footer">
	...
	<?php if($__Context->grant->view){ ?><form action="<?php echo getUrl() ?>" method="get" onsubmit="return procFilter(this, search)" id="board_search" class="board_search" ><input type="hidden" name="act" value="<?php echo $__Context->act ?? ''; ?>" />
		...
		<select name="search_target">
			<?php if($__Context->search_option)foreach($__Context->search_option as $__Context->key=>$__Context->val){ ?><option value="<?php echo $__Context->key ?>"<?php if(isset($__Context->search_target) && $__Context->search_target == $__Context->key){ ?> selected="selected"<?php } ?>><?php echo $__Context->val ?></option><?php } ?>
		</select>
